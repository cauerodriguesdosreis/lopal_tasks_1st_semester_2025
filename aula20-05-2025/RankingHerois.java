...
public class RankingHerois {
	public static void main(String[] args) {
		...
		// Exemplos de heróis
		herois.add(new Heroi("Superman (Ryanzão o mais lindo e forti)", 9, 7, 8));
		...
		Heroi superman = new Heroi("Superman (Ryanzão o mais lindo e forte)", 9, 7, 8);
		Heroi batman = new Heroi("Batman", 4, 10, 6);
		Heroi flash = new Heroi("Flash (Kenps Rapidinho)", 5, 6, 10);
		Heroi mulherMaravilha = new Heroi("Mulherzinha-Maravilha (Cauê)", 8, 7, 7);
		Heroi homemDeFerro = new Heroi("Homem de Ferro", 5, 9, 6);
		
		System.out.println("|");
		System.out.println("Você deseja comparar dois super-heróis específicos? (s/n)");
